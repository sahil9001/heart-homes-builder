    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Information */}
          <div>
            <h3 className="text-xl font-display font-bold text-white mb-4">SS <span className="text-accent">Constructions</span></h3>
          ...
          <div>
            ...
            <address className="not-italic">
              <div className="flex items-start space-x-3 mb-3">
                <svg className="w-5 h-5 mt-0.5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <div className="text-gray-300">
                  <p>Main Office:</p>
                  <p>123 Construction Way, Civil Lines</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">info@ssconstructions.com</p>
              </div>
            </address>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-300">
              ...
              <li>
                ...
                <br />Closed (Available for site visits by appointment)
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>© {currentYear} SS Constructions. All rights reserved.</p>
