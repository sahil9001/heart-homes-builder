...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0A0A0A] border-t border-[#222222] text-[#FAFAFA]">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Company Information */}
          <div>
            <h3 className="text-xl font-display font-bold text-[#FAFAFA] mb-4">Crafted <span className="text-[#5B8DEF]">Constructions</span></h3>
            <p className="mb-4 text-[#888888]">Homes built with heart, starting at ₹ 1,600 / sq ft. Building quality homes and lasting relationships since 2016.</p>
            <div className="flex space-x-4 mt-4">
              <a href="https://facebook.com" className="text-[#888888] hover:text-[#5B8DEF] transition-colors" aria-label="Facebook">
              ...
              <a href="https://instagram.com" className="text-[#888888] hover:text-[#5B8DEF] transition-colors" aria-label="Instagram">
              ...
              <a href="https://twitter.com" className="text-[#888888] hover:text-[#5B8DEF] transition-colors" aria-label="Twitter">
              ...
              <a href="https://youtube.com" className="text-[#888888] hover:text-[#5B8DEF] transition-colors" aria-label="YouTube">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-medium mb-4 text-[#FAFAFA]">Quick Links</h4>
            <ul className="space-y-2">
              <li><Link to="/" className="text-[#888888] hover:text-[#5B8DEF] transition-colors">Home</Link></li>
              <li><Link to="/services" className="text-[#888888] hover:text-[#5B8DEF] transition-colors">Services & Packages</Link></li>
              <li><Link to="/our-story" className="text-[#888888] hover:text-[#5B8DEF] transition-colors">Our Story</Link></li>
              <li><Link to="/projects" className="text-[#888888] hover:text-[#5B8DEF] transition-colors">Projects</Link></li>
              <li><Link to="/contact" className="text-[#888888] hover:text-[#5B8DEF] transition-colors">Contact Us</Link></li>
            </ul>
          </div>

          {/* Contact Information */}
          <div>
            <h4 className="text-lg font-medium mb-4 text-[#FAFAFA]">Contact Us</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-[#888888]">+91 84355 32184</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-[#888888]">info@craftedconstructions.com</p>
              </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-[#222222] text-sm text-[#888888]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>© {currentYear} Crafted Constructions. All rights reserved.</p>
            <div className="mt-4 md:mt-0">
              <ul className="flex space-x-6">
                <li><Link to="/privacy" className="hover:text-[#5B8DEF] transition-colors">Privacy Policy</Link></li>
                <li><Link to="/terms" className="hover:text-[#5B8DEF] transition-colors">Terms of Service</Link></li>
                <li><Link to="/sitemap" className="hover:text-[#5B8DEF] transition-colors">Sitemap</Link></li>
              </ul>
            </div>
          </div>
        </div>
