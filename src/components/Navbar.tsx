      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <Link to="/" className="flex items-center">
            <span className="font-display font-bold text-2xl text-primary">SS <span className="text-accent">Constructions</span></span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/projects" className="font-medium text-gray-700 hover:text-primary transition-colors">Projects</Link>
        ...
        <div className="md:hidden bg-white shadow-lg border-t">
          <div className="container mx-auto px-4 py-3">
            <div className="flex flex-col space-y-3">
              ...
              <Link to="/projects" className="py-2 font-medium text-gray-700 hover:text-primary" onClick={() => setMobileMenuOpen(false)}>Projects</Link>
              ...
              <Button className="w-full bg-accent hover:bg-accent/90" onClick={() => {window.location.href="/contact"; setMobileMenuOpen(false);}}>
                Get Free Quote
              </Button>
            </div>
          </div>
