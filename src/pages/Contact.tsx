        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-gray-600 mb-8">
                You can also reach out to us directly using the contact information below or visit one of our offices.
              </p>
              
              <div className="space-y-8">
                {/* Raipur Office */}
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="font-display font-medium text-xl mb-4">Raipur Office (Headquarters)</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <p className="text-gray-600">
                        123 Construction Way, Civil Lines<br />
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-600">raipur@ssconstructions.com</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Nagpur Office */}
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="font-display font-medium text-xl mb-4">Nagpur Office</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <p className="text-gray-600">
                        456 Builder Avenue, Dharampeth<br />
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-600">nagpur@ssconstructions.com</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Bhandara Office */}
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="font-display font-medium text-xl mb-4">Bhandara Office</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <p className="text-gray-600">
                        789 Construction Street, Near Bus Stand<br />
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-600">bhandara@ssconstructions.com</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Office Hours */}
              <div className="mt-8">
                <h3 className="font-display font-medium text-xl mb-4">Office Hours</h3>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-display font-medium mb-4">Find Us</h2>
            <p className="text-gray-600 max-w-xl mx-auto">
              Visit our offices in Raipur, Nagpur, and Bhandara to discuss your project in person.
            </p>
          </div>
          
          <div className="bg-white rounded-xl shadow-soft overflow-hidden">
            <iframe
              title="SS Constructions Office Locations"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14871.366221377399!2d81.6129483!3d21.2497355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a28dda23be28229%3A0xa4d0c11aec037d18!2sCivil%20Lines%2C%20Raipur%2C%20Chhattisgarh!5e0!3m2!1sen!2sin!4v1654325689542!5m2!1sen!2sin"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
